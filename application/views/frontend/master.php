...
<html lang="en">
<head>
	<title>Night Club - A Multipurpose Template</title>
	<meta charset="UTF-8">
...
<div class="nc_preloader">
	<div class="loader_overlay">
		<div class="loader_image">
			<img src="<?= base_url()?>assets/frontend/images/icon/music_loader.gif" alt="loader">
		</div>
	</div>
</div>
<!--  preloader start -->
			...
			<div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.0.7">
				<ul>
					...
					<li data-index="rs-1" data-transition="zoomin" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"   data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
						<!-- MAIN IMAGE -->
						<img src="<?= base_url()?>assets/frontend/images/bg/header_bg_1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						<!-- LAYER NR. 1 -->
						<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-1-layer-1" data-x="center" data-hoffset="" data-y="center" data-voffset="-30" data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']" data-transform_idle="o:1;"
							 ...
							 data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"  style="z-index: 5; white-space: nowrap;">
							<div class="center_img">
								<img src="<?= base_url()?>assets/frontend/images/icon/Logo.svg" class="img-responsive" alt="logo">
							</div>
						</div>
						<!-- LAYER NR.1-->
						<!-- LAYER NR. 2 -->
						<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-1-layer-2" data-x="center" data-hoffset="" data-y="center" data-voffset="30" data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']" data-transform_idle="o:1;"
							 data-transform_in="y:-50px;s:2000;opacity:0;e:Power4.easeInOut;"
							 data-transform_out="s:1000;opacity:1;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
							 data-start="2000" data-splitin="none" data-splitout="none" data-responsive_offset="on"  style="z-index: 5; white-space: nowrap;">
							<div class="nc_logo_center">
								<p class="logo_bottom_text">Have a good time </p>
							</div>
							<!-- LAYER NR.2-->
						</div>
					</li>
					<li data-index="rs-2" data-transition="zoomin" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"   data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
						<!-- MAIN IMAGE -->
						<img src="<?= base_url()?>assets/frontend/images/bg/slide_2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						<!-- LAYER NR. 1 -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-4">
					<div class="nc_logo">
						<a href="index.html">
							<img src="<?= base_url()?>assets/frontend/images/icon/Logo_main.svg" alt="logo">
						</a>
					</div>
				</div>
					...
					<div class="navigation_main">
						...
						<div class="nc_navigations">
							<ul class="menu">
								...
								<li><a href="blog-category.html">blog</a>
									<ul class="sub-menu">
										<li><a href="blog-category.html">blog category</a></li>
										<li><a href="blog-center.html">blog center</a></li>
										<li><a href="blog-full-width.html">blog full width</a></li>
										<li><a href="blog-single.html">blog single</a></li>
										<li><a href="blog-single-with-sidebar.html">blog single with sidebar</a>
										</li>
									</ul>
								</li>
								...
								<li><a href="conatct-us.html">contact us</a></li>
							</ul>
						</div><!--  navigation -->
					</div>
				</div>
			...
			<div class="nc_club_services">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="nc_thumb_wrapper bottom_1">
						<img src="<?= base_url()?>assets/frontend/images/thumb1.jpg" class="img-responsive" alt="thumb">
						<!-- overlay start -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="nc_thumb_wrapper bottom_2">
						<img src="<?= base_url()?>assets/frontend/images/reastaurant_1.jpg" class="img-responsive" alt="thumb">
						<!-- overlay start -->
						<div class="nc_sevice_overlay triangle_shape">
							<div class="overlay_inner">
								<div class="border">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="nc_thumb_wrapper bottom_3">
						<img src="<?= base_url()?>assets/frontend/images/thumb2.jpg" class="img-responsive" alt="thumb">
						<!-- overlay start -->
						<div class="nc_sevice_overlay triangle_shape">
							<div class="overlay_inner">
								<div class="border">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<!-- middle heading end-->
					<div class="nc_event_main event_crousel">
						<!-- item start -->
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb1.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<!-- <a href="#" class="nc_btns triangle_btn">book now</a> -->
											<a href="#" class="read_m_btn triangle_btn">book now</a>
										</div>
										<div class="overlay_inner_bottom">
											<h4>Night Club</h4>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,
												or randomised words which don't look even slightly believable.</p>
										</div>
								...
								<div class="bottom_tab">
									<span>25 Dec</span> <span>10:30 PM</span> <span>City Plaza, Newyork</span>
								</div>
							</div><!-- event cover -->
						</div> <!-- item end -->
						<!-- item start -->
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb2.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<a href="#" class="read_m_btn triangle_btn">book now</a>
								...
								<div class="bottom_tab">
									<span>31 Dec</span> <span>10:30 PM</span> <span>Las Vegas, Nevada</span>
								</div>
							</div><!-- event cover -->
						</div> <!-- item end -->
						<!-- item start -->
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb3.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<a href="#" class="read_m_btn triangle_btn">book now</a>
						...
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb4.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<a href="#" class="read_m_btn triangle_btn">book now</a>
						...
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb5.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<a href="#" class="read_m_btn triangle_btn">book now</a>
						...
						<div class="item">
							<div class="nc_event_cover">
								<div class="nc_thumb_wrapper">
									<img src="<?= base_url()?>assets/frontend/images/event/event-thumb6.jpg" alt="">
									<!-- overlay start -->
									<div class="thumb_overlay triangle_shape">
										<div class="book_now_button">
											<a href="#" class="read_m_btn triangle_btn">book now</a>
		...
		<div class ="photo_grid width_1">
			<div class="gallery_cover">
				<a href="#small_dialog1" class="photo_gallery_popup">
					<img src="<?= base_url()?>assets/frontend/images/gallery/gallery1.jpg"  alt="gallery">
					<div class="gallery_overlay triangle_shape"> </div>
				</a>
				<div id="small_dialog1" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="<?= base_url()?>assets/frontend/images/gallery/big/gallery1_big.jpg"  alt="gallery">
		...
		<div class ="photo_grid width_2">
			<div class="gallery_cover">
				...
				<div id="small_dialog2" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery2_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
		...
		<div class ="photo_grid width_3">
			<div class="gallery_cover">
				...
				<div id="small_dialog3" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery3_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
		...
		<div class ="photo_grid width_4">
			<div class="gallery_cover">
				...
				<div id="small_dialog4" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery4_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
		...
		<div class ="photo_grid width_1 margin-top">
			<div class="gallery_cover">
				...
				<div id="small_dialog5" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery5_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
		...
		<div class ="photo_grid width_5">
			<div class="gallery_cover">
				...
				<div id="small_dialog6" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery6_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
						</div>
					</div>
					<div class="gallery_desc">
		...
		<div class ="photo_grid width_5">
			<div class="gallery_cover">
				...
				<div id="small_dialog7" class="zoom_anim mfp-hide">
					<div class="gallery_thumb">
						<img src="images/gallery/big/gallery7_big.jpg"  alt="gallery">
						<div class="overlay triangle_shape">
						</div>
					</div>
					<div class="gallery_desc">
				...
				<div class="middle_inner">
					<div class="nc_media_player">
						<div class="track_thumb col-sm-3">
							<img src="images/track/track_thumb.jpg" class="img-responsive" alt="track thumb" />
						</div>
						<div class="col-sm-9 pad-l-0">
							<div class="media_player">
								<audio id="mejs" controls="controls" data-mejsoptions='{"alwaysShowControls": true}'>
									<source src="track/YouBelongWithMe.mp3" title="You Belong With Me2" type="audio/mp3" />
								</audio>
							</div>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="track_crousel mejs-list">
							<div class="item">
								<img src="images/track/track1.jpg" alt="track">
								<!-- overlay start -->
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/LeanOn.mp3" data-title="Lean On" data-prev="audio_7" id="audio_1" data-next="audio_2"></i>
									</div>
							...
							<div class="item">
								<img src="images/track/track2.jpg" alt="track">
								<!-- overlay start -->
								<div class="track_overlay triangle_shape">

									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me1" data-prev="audio_1" id="audio_2" data-next="audio_3">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
							...
							<div class="item active">
								<img src="images/track/track3.jpg" alt="track">
								<!-- overlay start -->
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me2" data-prev="audio_2" id="audio_3" data-next="audio_4">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
							...
							<div class="item">
								<img src="images/track/track4.jpg" alt="track">
								<!-- overlay start -->
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me3" data-prev="audio_3" id="audio_4" data-next="audio_5">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
							...
							<div class="item">
								<img src="images/track/track5.jpg" alt="track">
								<!-- overlay start -->
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me4" data-prev="audio_4" id="audio_5" data-next="audio_6">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
							...
							<div class="item">
								...
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me5" data-prev="audio_5" id="audio_6" data-next="audio_7">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
							...
							<div class="item">
								...
								<div class="track_overlay triangle_shape">
									<div class="play_button">
										<i class="fa fa-play" data-audio="track/YouBelongWithMe.mp3" data-title="You Belong With Me6" data-prev="audio_6" id="audio_7" data-next="audio_1">
										</i>
									</div>
									<div class="bottom_song_title">
										you belong...
...
<!-- music section end -->
<!-- video section start -->
<div class="main_wrapper video_section">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="nc_heading_middle">
				...
				<div class="middle_inner">
					<div class="video_crousel">
						<div class="item">
							<div class="video_overlay">
								<a class="video_popup" href="#video_1" type="video/mp4">
									<img src="images/video_poster.jpg" alt="video">
									<div class="overlay_button triangle_shape">
										<i class="fa fa-play-circle"></i>
									</div>
								</a>
								<div id="video_1" class="video_zoom triangle_shape mfp-hide">
									<video src="images/media/space.mp4"
										   poster="images/video_poster_big.jpg"
						...
						<div class="item">
							<div class="video_overlay">
								<a class="video_popup" href="#video_2" type="video/mp4">
									<img src="images/video_poster.jpg" alt="video">
									<div class="overlay_button triangle_shape">
										<i class="fa fa-play-circle"></i>
									</div>
								</a>
								<div id="video_2" class="video_zoom triangle_shape mfp-hide">
									<video src="images/media/space.mp4"
										   poster="images/video_poster_big.jpg"
										   controls="controls" preload="none">
									</video>
...
<div class="main_wrapper nc_testimonial_wrapper">
	<div class="color_overlay">
		<div class="container">
			<div class="row">
				<div class="testimonial_crousel" id="testimonials">
					<div class="item">
						<div class="nc_testimonial_inner">
							<div class="thumbnail">
								<img src="images/testimonial_1.jpg" alt="">
							</div>
							<h4 class="test_title">Jhon Doe</h4>
							<p>
							...
							<div class="social_icons">
								<a href="#" class="triangle_box"><i class="fa fa-facebook"></i></a>
								<a href="#" class="triangle_box"><i class="fa fa-twitter"></i></a>
								<a href="#" class="triangle_box"><i class="fa fa-google"></i></a>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="nc_testimonial_inner">
							...
							<h4 class="test_title">marry Doe</h4>
							<p>
								There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected
								humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be
								sure there isn't anything embarrassing hidden in the middle of text.
		...
		<div class="row">
			...
			<div class="middle_inner blog_post_home" id="subs_scroll">
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="blog_cover">
						<div class="blog_thumb">
							<img src="images/blog/blog1.jpg" class="img-responsive" alt="blog">
							<div class="thumb_overlay triangle_shape">
							</div>
						</div>
						<div class="blog_desc home_desc">
							<h3><a href="blog-category.html">more than 20 year of night club</a></h3>
							<div class="nc_comments">BY:
								<span>Admin </span>
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="blog_cover">
						<div class="blog_thumb">
							<img src="images/blog/blog2.jpg" class="img-responsive" alt="blog">
							<div class="thumb_overlay triangle_shape">
							</div>
						</div>
						<div class="blog_desc home_desc">
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="blog_cover">
						<div class="blog_thumb">
							<img src="images/blog/blog3.jpg" class="img-responsive" alt="blog">
							<div class="thumb_overlay triangle_shape">
							</div>
						</div>
						<div class="blog_desc home_desc">
				...
				<div class="row">
					<div class="col-md-4">
						<aside class="widget footer_widget">
							<div class="footer_logo">
								<a href="index.html">
									<img src="images/icon/Logo_main.svg" alt="logo">
								</a>
							</div>
					...
					<div class="col-md-4">
						<aside class="widget nc_recent_post">
							...
							<ul>
								<li> <img src="images/blog/recent_post1.jpg" alt="Recent blog">
									<div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
										<span >April 17, 2018</span> </div>
								</li>
								<li> <img src="images/blog/recent_post2.jpg" alt="Recent blog">
									<div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
										<span >April 17, 2018</span> </div>
								</li>
	...
	<div class="main_wrapper nc_footer_strip">
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="left_text">
						<p class="footer_text">Stay Connected With Us Night Club</p>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="social_icons footer_social">
						<a href="#" class="triangle_box"><i class="fa fa-facebook"></i></a>
						<a href="#" class="triangle_box"><i class="fa fa-twitter"></i></a>
						<a href="#" class="triangle_box"><i class="fa fa-google-plus"></i></a>
						<a href="#" class="triangle_box"><i class="fa fa-skype"></i></a>
						<a href="#" class="triangle_box">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="13px" height="13px" viewBox="0 0 533.333 533.333" style="enable-background:new 0 0 533.333 533.333;" xml:space="preserve"><g><path d="M498.852,200h-29.275h-0.624c-18.316,0-34.369-15.491-35.62-33.333l0,0C433.335,71.527,356.636,0,260.838,0H173.43 C77.694,0,0.067,77.083,0,172.222V361.18c0,95.131,77.694,172.153,173.429,172.153h186.677 c95.807,0,173.228-77.022,173.228-172.153V239.105C533.333,220.094,518,200,498.852,200z M166.667,133.333h100 c18.333,0,33.333,15,33.333,33.333S285,200,266.667,200h-100c-18.333,0-33.333-15-33.333-33.333S148.333,133.333,166.667,133.333z M366.667,400h-200c-18.333,0-33.333-15-33.333-33.333s15-33.334,33.333-33.334h200C385,333.333,400,348.334,400,366.667 S385,400,366.667,400z" fill=""/></g> </svg>
						</a>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="nc_copright_text">
						<p class="footer_text">CopyRight @ 2018 NightClub psd template all right</p>
					</div>
				</div>
			</div>
		</div>
...
<!-- Mirrored from kamleshyadav.in/html/rockon/night-club/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Dec 2018 11:02:56 GMT -->
</html>
